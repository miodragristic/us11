...
import Union from '../../assets/posters/Union.png';
...
const TrendingPlayers = () => {
  const players = [
    ...
    { name: 'Mikael Uhre', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRf5qu95-49m4uxGDX5Z3qfQj1pRZduVQQsrg&s', link: './Uhre' },
  ];
...
const PhiladelphiaUnion = () => {
  const items = [
    { id: 1, title: 'Jerseys', imageUrl: 'path/to/jersey-image.jpg', link: './PhiladelphiaUnionJerseys', price: '$79.99' },
    { id: 2, title: 'T-Shirts', imageUrl: 'path/to/tshirt-image.jpg', link: './PhiladelphiaUnionTShirts', price: '$29.99' },
    { id: 3, title: 'Merchandise', imageUrl: 'path/to/merch-image.jpg', link: './PhiladelphiaUnionMerchandise', price: '$49.99' },
  ];
