...
const TrendingPlayers = () => {
  const players = [
    { name: 'Robin Jansson', image: 'https://cdn1.sheffieldwednesday.news/uploads/8/2024/07/GettyImages-2160330033-1024x683.jpg', link: './jansson' },
    { name: 'Luis Muriel', image: 'https://icdn.sempremilan.com/wp-content/uploads/2021/12/ssc-napoli-v-atalanta-bc-serie-a-1.jpg', link: './muriel' },
      ...
      <div className='max-w-4xl mx-auto py-8 px-4 md:px-0'>
        ...
        <div className='mb-6'>
          ...
          />
              ...
              <a
            href="https://ticketnetwork.lusg.net/6ynJPE"
            target="_blank"
