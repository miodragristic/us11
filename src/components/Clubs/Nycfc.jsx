...
import Nyc from '../../assets/posters/Nyc.png';
import { FaShoppingCart } from 'react-icons/fa';

const TrendingPlayers = () => {
  const players = [
    { name: 'Maxi Moralez', image: 'https://cdn.eleco.com.ar/media/2022/12/deportes_32.jpg', link: './TatyCastellanos' },
    { name: 'Santiago Rodríguez', image: 'https://assets.goal.com/images/v3/getty-2150744981/crop/MM5DGOBYHA5DEMJYG45G433XMU5DOMBSHIYTANQ=/GettyImages-2150744981.jpg', link: './MaximeChanot' },
    { name: 'Monsef Bakrar', image: 'https://www.telegram.hr/wp-content/uploads/2024/12/monsef-bakrar.jpg', link: './SantiagoRodriguez' },
      ...
      <div className='max-w-4xl mx-auto py-8 px-4 md:px-0'>
        ...
        <div className='text-[#020617] mb-8'>
          ...
          <ul className='list-disc list-inside'>
            ...
            <li><strong>Head Coach:</strong> Nick Cushing</li>
