...
const TrendingPlayers = () => {
  const players = [
    ...
    { name: 'Walker Zimmerman', image: 'https://the18.com/sites/default/files/styles/x-large_square__4_3_/public/feature-images/20220429-The18-Image-Walker-Zimmerman-GettyImages-1316150108.jpeg?itok=dewBb8Ju', link: './WalkerZimmerman' },
      ...
      <div className='max-w-4xl mx-auto py-8 px-4 md:px-0'>
        ...
        <div className='text-[#020617] mb-8'>
          ...
          <ul className='list-disc list-inside'>
            ...
            <li><strong>Head Coach:</strong> Gary Smith</li>
