...
import Minnesota from '../../assets/posters/Minnesota.png'
import { FaShoppingCart } from 'react-icons/fa';

const TrendingPlayers = () => {
  const players = [
    { name: 'Robin Lod', image: 'https://www.sportti.com/wp-content/uploads/2024/02/robin_lod_2023_minnesota.jpg', link: './RobinLod' },
    { name: 'Franco Fragapane', image: 'https://northlandsoccer.com/wp-content/uploads/2023/05/2023.05.09_MINvPHL_USOC_0011_LAKE0231.jpg', link: './FrancoFragapane' },
    { name: 'Teemu Pukki', image: 'https://www.sportti.com/wp-content/uploads/2024/03/teemu_pukki_2024maalis_minnesota.jpg', link: './TeemuPukki' },
...
const MinnesotaUnited = () => {
  const items = [
    { id: 1, title: 'Jerseys', imageUrl: 'path/to/jersey-image.jpg', link: './MinnesotaJerseys', price: '$79.99' },
    { id: 2, title: 'T-Shirts', imageUrl: 'path/to/tshirt-image.jpg', link: './MinnesotaTShirts', price: '$29.99' },
    { id: 3, title: 'Merchandise', imageUrl: 'path/to/merch-image.jpg', link: './MinnesotaMerchandise', price: '$49.99' },
  ];
      ...
      <div className='max-w-4xl mx-auto py-8 px-4 md:px-0'>
        ...
        <div className='text-[#020617] mb-8'>
          ...
          <ul className='list-disc list-inside'>
            ...
            <li><strong>Head Coach:</strong> Adrian Heath</li>
