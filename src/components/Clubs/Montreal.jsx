...
import Montreal from '../../assets/posters/Montreal.png';
import { FaShoppingCart } from 'react-icons/fa';

const TrendingPlayers = () => {
  const players = [
    { name: 'Samuel Piette', image: 'https://lastwordonsports.com/soccer/wp-content/uploads/sites/14/2022/11/Canada-Mens-Soccer-Team-Player-Samuel-Piette-in-2019.jpg', link: './Piette' },
    ...
    { name: 'Caden Clark', image: 'https://cdn.wsn.com/filters:format(webp)/fit-in/1200x630/1727245998/cf-montreal-vs-san-jose-2024-09-28.jpg', link: './Clark' },
