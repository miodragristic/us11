  ...
  return (
    <div className='w-full min-h-screen bg-white pt-[150px]'>
      <div className='max-w-4xl mx-auto py-8 px-4 md:px-0'>
        <h1 className='text-4xl sm:text-7xl font-bold text-[#020617] mb-4'>Houston Dynamo</h1>
        <div className='mb-6'>
          {/* Add an image of Houston Dynamo here */}
          <img
            src={Houston}
            alt='Houston Dynamo'
          ...
          />
              ...
              <a 
            href="https://ticketnetwork.lusg.net/bOPEk6"
            target="_blank"
        ...
        <div className='text-[#020617] mb-8'>
          ...
          <ul className='list-disc list-inside'>
            <li><strong>Full Name:</strong> Houston Dynamo</li>
            <li><strong>Nickname(s):</strong> The Orange</li>
            <li><strong>Founded:</strong> 2006</li>
            <li><strong>Stadium:</strong> Shell Energy Stadium, Houston, Texas</li>
            <li><strong>Capacity:</strong> 22,000</li>
            <li><strong>Owner:</strong> The Houston Dynamo Ownership Group</li>
            <li><strong>Head Coach:</strong> Ben Olsen</li>
        ...
        {/* Additional Text */}
        <div className='text-[#020617] mb-8'>
          <h2 className='text-2xl font-semibold mb-2'>A Powerhouse in the Heart of Texas</h2>
          <p>
            The Houston Dynamo are a proud member of Major League Soccer, having been established in 2006. Known for their passionate fanbase and vibrant orange color, the team has always been one of the most exciting clubs in the league.
          </p>
          <p>
            The Dynamo have seen success in both domestic and international competitions, and with a talented roster including stars like Héctor Herrera and Darwin Quintero, they continue to be a competitive force in the league.
          </p>
          <p>
            Home games are played at Shell Energy Stadium, where fans can experience the electric atmosphere as the team fights for victory on the pitch.
          </p>
        </div>
