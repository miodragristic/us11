...
const JulianFernandez = () => {
  const items = [
    { id: 1, title: "Julián Fernández Home Jersey", imageUrl: 'https://example.com/jersey.jpg', link: 'https://www.example.com/product/1', price: '$129.99' },
    { id: 2, title: "Signed Julián Fernández Soccer Ball", imageUrl: 'https://example.com/ball.jpg', link: 'https://www.example.com/product/2', price: '$249.99' },
    { id: 3, title: "Julián Fernández Poster", imageUrl: 'https://example.com/poster.jpg', link: 'https://www.example.com/product/3', price: '$19.99' },
    { id: 4, title: "New York City FC Scarf", imageUrl: 'https://example.com/scarf.jpg', link: 'https://www.example.com/product/4', price: '$29.99' },
    { id: 5, title: "Julián Fernández Autographed Photo", imageUrl: 'https://example.com/photo.jpg', link: 'https://www.example.com/product/5', price: '$99.99' },
  ];

  return (
    <div className='w-full min-h-screen bg-gray-100 pt-[150px]'>
      <div className='max-w-4xl mx-auto py-8 px-4 md:px-0'>
        <h1 className='text-4xl sm:text-7xl font-bold text-[#020617] mb-4'>Julián Fernández</h1>
        ...
        <div className='text-[#020617] mb-8'>
          ...
          <ul className='list-disc list-inside'>
            <li><strong>Date of Birth:</strong> January 30, 2004 (Buenos Aires, Argentina)</li>
            ...
            <li><strong>Senior Career:</strong> 
              <ul className='list-disc list-inside ml-5'>
                <li>Vélez Sarsfield (2022–2023): 54 appearances, 4 goals</li>
                <li>New York City FC (2023–): 24 appearances, 4 goals</li>
              </ul>
            </li>
            <li><strong>International Career:</strong> 
              <ul className='list-disc list-inside ml-5'>
                <li>Argentina U-20: 4 appearances</li>
              </ul>
            </li>
          </ul>
        </div>
        ...
        {/* About Section */}
        <div className='text-[#020617] mb-8'>
          <h2 className='text-2xl font-semibold mb-2'>About Julián Fernández</h2>
          <p>
            Julián Fernández is a talented young winger from Buenos Aires, Argentina. Known for his pace and creativity on the flanks, Fernández began his professional career at Vélez Sarsfield, where he quickly established himself as a promising player. In 2023, he made the move to New York City FC in Major League Soccer, continuing to develop his skills and contribute to the team's success.
          </p>
          <p>
            A former Argentina U-20 international, Fernández is viewed as a player with immense potential, and fans are excited to see how his career unfolds both domestically and internationally.
          </p>
        </div>

        {/* Shop Section */}
        <h1 className='text-4xl sm:text-7xl font-bold text-[#020617] mb-4'>Shop Julián Fernández Merchandise</h1>
...
export default JulianFernandez;
