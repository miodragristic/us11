...
const TimReam = () => {
  const items = [
    { id: 1, title: "Charlotte FC Tim Ream Green Home Jersey 2024", imageUrl: 'https://example.com/jersey1.jpg', link: 'https://www.example.com/product/1', price: '$129.99' },
    { id: 2, title: "Signed Tim Ream Charlotte FC Soccer Ball", imageUrl: 'https://example.com/ball1.jpg', link: 'https://www.example.com/product/2', price: '$299.99' },
    { id: 3, title: "Charlotte FC Tim Ream Name & Number T-Shirt", imageUrl: 'https://example.com/tshirt1.jpg', link: 'https://www.example.com/product/3', price: '$34.99' },
    { id: 4, title: "Tim Ream Signed Charlotte FC Match Cleats", imageUrl: 'https://example.com/cleat1.jpg', link: 'https://www.example.com/product/4', price: '$349.99' },
    { id: 5, title: "Tim Ream Charlotte FC Green Training Jersey", imageUrl: 'https://example.com/jersey2.jpg', link: 'https://www.example.com/product/5', price: '$119.99' },
  ];
    ...
    <div className='w-full min-h-screen bg-white pt-[150px]'>
      <div className='max-w-4xl mx-auto py-8 px-4 md:px-0'>
        ...
        <div className="mb-10 text-center text-sm text-gray-500">
          <p>Creator: Michael Pimentel/ISI Photos 
| 
Credit: Getty Images
Copyright: 2024 Michael Pimentel/ISI Photos</p>
        </div>
