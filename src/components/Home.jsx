...
const HomePage = () => {
  ...
  const blogPosts = [
    { id: 6, title: 'San Diego FC Makes History with First MLS Win', author: 'Mio Ristic', date: 'February 25, 2025', excerpt: 'San Diego FC secures a dramatic victory in their inaugural MLS match.', imageUrl: SanDiegoLogo, link: '/blog/san-diego-first-win' },
    { id: 5, title: 'Inter Miami: A New Attempt to Claim the Title', author: 'Mio Ristic', date: 'June 29, 2024', excerpt: 'The Glamorous Heartbeat of American Soccer.', imageUrl: Inter, link: '/blog/inter-miami-global-attraction' },
    { id: 4, title: 'MLS in FC25', author: 'Mio Ristic', date: 'July 1, 2024', excerpt: 'FC25 – Overview, MLS Clubs, and U.S. National Team.', imageUrl: 'https://drop-assets.ea.com/images/1BY2V24NDqyjYKlDV8mJrx/ff63d00bb5bf24ad0c1b87adcd0e2771/EA_FC25_Standard_KeyArt_16-9_3840x2160.jpg?im=AspectCrop=(16,9),xPosition=0.5384114583333334,yPosition=0.538425925925926&q=85&w=1280', link: '/blog/FC25' },
